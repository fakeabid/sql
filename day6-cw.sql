...
1)
SELECT title,author FROM books_4
UNION
SELECT title,author FROM bestsellers_4;
...
3)
SELECT AVG(price) FROM books_4;

4)
SELECT COUNT(*) FROM books_4;

5)
SELECT title AS 'Book Title', author AS 'Written By' FROM books_4;